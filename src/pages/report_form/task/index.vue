<template>
    <div class="event event-wrapper">
        ...
        <div class="attendance-list">
            ...
            <el-table ref="multipleTable" v-loading="loading" class="bigTable" :row-key=" (row) => {return row.id;}" :data="tableData" border stripe tooltip-effect="dark" @selection-change="handleSelectionChange">
